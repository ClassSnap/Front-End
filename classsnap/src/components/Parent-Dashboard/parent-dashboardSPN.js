...
import UnansweredQuestionList from "./SPN/UnansweredQuestionListSPN";
...
import ParentRatingForm from "./SPN/RatingFormSPN";
      ...
      <Dashboard>
        ...
        <RightBar>
          <div className={showWelcome ? "welcome" : "welcome off"}>
            ...
            <Link to="/parent/spn/addchild">
              <Button>Ingresa niño</Button>
            </Link>
          </div>
          <ClassList
            session={session}
